 ...
 *
 */
public class Digit extends InputWithClassification{
	...
	/**
	 * creates a Digit
	 * @param classification The number on the picture
	...
	/**
	 * adds all rows of the picture behind each other
	 * @return The Picture in 1D
	 */
